...
- For example, typing the command 
    ...
    who 
    ```
    causes the system to execute the program stored in the file lbinlwho,4 which prints a list of people who are currently logged in to the system. While _who_ executes, the shell waits for it to finish and then prompts the user for another command
- By typing 
   ```bash
    who &
    ```
